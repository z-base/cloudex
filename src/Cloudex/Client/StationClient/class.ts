/** must emit the events as described in the asynchronous event system for stuff that is not internally handled */
/** must also expose apis to send deltas via broadcast and snapshots via backup, and also  the ability to respond to a state snapshot sync request via some method  */

import { Bytes } from "bytecodec";
import type { ResourceIdentifier } from "../../helpers/ensureCloudexIdentifier";
import {
  packMessage,
  unpackMessage,
  type ResourceAgentMessage,
} from "../../helpers/message";
import { validateIdentifier } from "../../helpers/ensureCloudexIdentifier";
